package com.example.administrator.tourguidetest.tourguide;
...
import com.example.administrator.tourguidetest.R;
...
//                    performAnimationOn(fab);
    ...
    private void setupToolTip(){
        ...
        if (mToolTip != null) {
            ...
            ImageView iv_tool_tip = (ImageView) mToolTipViewGroup.findViewById(R.id.iv_tool_tip);

            /* set tooltip attributes */
            toolTipContainer.setBackgroundColor(mToolTip.mBackgroundColor);
            
            iv_tool_tip.setImageResource(mToolTip.mImageResource);
...
//                mToolTipViewGroup.setBackgroundColor(mActivity.getResources().getColor(R.color.tour_guide_bg));
            }
